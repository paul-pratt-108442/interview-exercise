...
- Create Angular project with ng: `ng new app.interview.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`app.interview.client.esproj`).
